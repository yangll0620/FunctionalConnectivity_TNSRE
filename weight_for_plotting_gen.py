...
# @Last Modified time: 2018-11-08 15:30:00
...
def weight_for_plotting_gen(matrix_conn, p_sig):
	...
	w_plot = matrix_conn * (matrix_conn>0.25).astype(float) # w_plot: the weights of significant edges remains, the weights of the insignificant edges = 0
	return w_plot